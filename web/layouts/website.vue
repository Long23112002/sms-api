      ...
      <v-container>
        <v-row>
          <v-col class="w-full d-flex">
            ...
            >
              Bắt Đầu
              <span v-show="$vuetify.breakpoint.lgAndUp">&nbsp;Miễn Phí</span>
            </v-btn>
            <v-btn
              v-show="$store.getters.getAuthUser !== null"
              exact-path
      ...
      <v-container>
        <v-row>
          <v-col cols="12" md="3">
            ...
            <p class="mt-n3">
              <v-btn href="" icon color="#1DA1F2">
                <v-icon>{{ mdiTwitter }}</v-icon>
              </v-btn>
              <v-btn
                href="https://github.com/Long23112002"
                icon
                large
                color="#ffffff"
              >
              ...
              <v-btn
                href="mailto:longjava2024@gmail.com"
                icon
                large
                color="#5865f2"
              >
          ...
          <v-col cols="12" md="3">
            <h2 class="text-h6 mb-2">Tài Nguyên</h2>
          ...
          <v-col cols="12" md="3">
            <h2 class="text-h6 mb-2">Nhà Phát Triển</h2>
            <ul style="list-style: none" class="pa-0">
              <li class="mb-2">
                <v-hover v-slot="{ hover }">
                  <a
          ...
          <v-col cols="12" md="3">
            <h2 class="text-h6 mb-2">Pháp Lý</h2>
            <ul style="list-style: none" class="pa-0">
              <li class="mb-2">
                <v-hover v-slot="{ hover }">
                  <nuxt-link
