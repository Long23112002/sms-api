  ...
  >
    <div class="w-full h-full">
      <v-app-bar height="60" :dense="$vuetify.breakpoint.mdAndDown">
        ...
        <v-toolbar-title>
          <div class="py-16">Tìm Kiếm Tin Nhắn</div>
        </v-toolbar-title>
        <v-progress-linear
          :active="loading"
      ...
      <v-container>
        <v-row>
          <v-col cols="12">
            <h5 class="text-h4 mb-3 mt-3">Tìm Kiếm Tin Nhắn</h5>
            <p>
              Trên trang này, bạn có thể tìm kiếm tất cả tin nhắn của mình theo số điện thoại,
              loại tin nhắn và trạng thái tin nhắn, thậm chí sử dụng nội dung của
              tin nhắn SMS. Bạn cũng có thể xóa hàng loạt tin nhắn và
              xuất tin nhắn của bạn ra file CSV.
            </p>
